...
/*  digitalWrite(PhaseaLowerPin, !LOW);
 ...
 if(PhaseaUpper){analogWrite(PhaseaUpperPin, val/4);}else{digitalWrite(PhaseaUpperPin, LOW);}
 digitalWrite(PhasebLowerPin, !PhasebLower);
 if(PhasebUpper){analogWrite(PhasebUpperPin, val/4);}else{digitalWrite(PhasebUpperPin, LOW);}
 digitalWrite(PhasecLowerPin, !PhasecLower);
 if(PhasecUpper){analogWrite(PhasecUpperPin, val/4);}else{digitalWrite(PhasecUpperPin, LOW);}
