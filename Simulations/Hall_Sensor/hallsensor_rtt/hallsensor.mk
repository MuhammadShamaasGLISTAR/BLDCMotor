...
# Autogenerated on: 13-Mar-2020 13:03:05
# Model: HALLSENSOR
# MyTemplate
# File name: hallsensor.mk
# Template: gmake 
...
MATLAB_ROOT_RELATIVE := C:\Program Files\MATLAB\R2013b\#MATLAB_ROOT_RELATIVE_END
...
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\hallsensor.c) $(call FORMAT_PATH,.\hallsensor_data.c)
else
SOURCE_FILES := $(call FORMAT_PATH,.\HardwareSerial.cpp) $(call FORMAT_PATH,.\Print.cpp) $(call FORMAT_PATH,.\WInterrupts.c) $(call FORMAT_PATH,.\WMath.cpp) $(call FORMAT_PATH,.\WString.cpp) $(call FORMAT_PATH,.\new.cpp) $(call FORMAT_PATH,.\wiring.c) $(call FORMAT_PATH,.\wiring_analog.c) $(call FORMAT_PATH,.\wiring_digital.c) $(call FORMAT_PATH,.\io_wrappers.cpp) $(call FORMAT_PATH,.\ert_main.c) $(call FORMAT_PATH,.\hallsensor.c) $(call FORMAT_PATH,.\hallsensor_data.c)
endif

HEADER_FILES := $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2013a\arduino-1.0\hardware\arduino\cores\arduino\HardwareSerial.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2013a\arduino-1.0\hardware\arduino\cores\arduino\Print.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2013a\arduino-1.0\hardware\arduino\cores\arduino\WString.h) $(call FORMAT_PATH,C:\MATLAB\SupportPackages\R2013a\arduino-1.0\hardware\arduino\cores\arduino\new.h) $(call FORMAT_PATH,.\hallsensor.h)
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2013a/arduino/include" -I"C:/MATLAB/SupportPackages/R2013a/arduino/blocks/sfcn/include" -I"D:/MuhammadShamaas/GLISTAR/Simulations/Hall_Sensor/hallsensor_rtt" -I"D:/MuhammadShamaas/GLISTAR/Simulations/Hall_Sensor" -I"C:/Program Files/MATLAB/R2013b/extern/include" -I"C:/Program Files/MATLAB/R2013b/simulink/include" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src" -I"C:/Program Files/MATLAB/R2013b/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2013b/rtw/c/ert" -I"C:/MATLAB/SupportPackages/R2013a/arduino-1.0/hardware/arduino/cores/arduino" -I"C:/MATLAB/SupportPackages/R2013a/arduino-1.0/hardware/arduino/variants/mega" -I"C:/MATLAB/SupportPackages/R2013a/arduino-1.0/libraries/Servo" -mmcu=atmega2560 -std=gnu99 -Wall -Wstrict-prototypes -g -Os -D"MODEL=hallsensor" -D"NUMST=2" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"TID01EQ=0" -D"F_CPU=16000000" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_ROTH_MEGA2560_=" -D"_RTT_NUMSERVOS_=0"

COMPILER_TCCFG_ARGS := -c -x none
COMPILER_ARGS := $(COMPILER_CODEGEN_ARGS) $(COMPILER_TCCFG_ARGS)

LINKER_CODEGEN_ARGS :=  -lm -mmcu=atmega2560 -g 
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  hallsensor.hex
